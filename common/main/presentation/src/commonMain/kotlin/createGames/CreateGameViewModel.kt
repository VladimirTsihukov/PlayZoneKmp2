...
import createGames.models.CreateGameAction
import createGames.models.CreateGameEvent
import createGames.models.CreateGameState
import di.Inject
...
class CreateGameViewModel : BaseSharedViewModel<
    ...
    override fun obtainEvent(viewEvent: CreateGameEvent) {
        when (viewEvent) {
            ...
            CreateGameEvent.SubmitChanges -> createGame()
        }
    }
